...
public class Translate {
    ...
    public static String dotrans(String transtext) throws Exception {
        GT g = GT.getInstance();
        return g.translateText(transtext,"auto","en");
    }
...
class GT {
    ...
    private static final String PATH="https://translate.googleapis.com/translate_a/single"; //Google address
